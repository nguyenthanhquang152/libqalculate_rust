...
fn is_constant(expr: &Expression) -> bool {
    match expr {
        ...
        Expression::Text(_) | Expression::Symbolic(_) | Expression::Variable(_) => false,
...
fn kind_priority(kind: crate::ast::StructureKind) -> u32 {
    ...
    match kind {
        ...
        StructureKind::Symbolic => 2,
        StructureKind::Variable => 3,
        StructureKind::Unit => 4,
        StructureKind::DateTime => 5,
        StructureKind::Addition => 6,
        StructureKind::Multiplication => 7,
        StructureKind::Division => 8,
        StructureKind::Inverse => 9,
        StructureKind::Power => 10,
        StructureKind::Negate => 11,
        StructureKind::Function => 12,
        StructureKind::Vector => 13,
        StructureKind::Remainder => 14,
        StructureKind::Modulo => 15,
        StructureKind::IntegerDivision => 16,
        StructureKind::ShiftLeft => 17,
        StructureKind::ShiftRight => 18,
        StructureKind::Factorial => 19,
        StructureKind::DoubleFactorial => 20,
        StructureKind::MultiFactorial => 21,
        StructureKind::Percent => 22,
        StructureKind::BitwiseAnd => 23,
        StructureKind::BitwiseOr => 24,
        StructureKind::BitwiseXor => 25,
        StructureKind::BitwiseNot => 26,
        StructureKind::LogicalAnd => 27,
        StructureKind::LogicalOr => 28,
        StructureKind::LogicalXor => 29,
        StructureKind::LogicalNot => 30,
        StructureKind::Comparison => 31,
        StructureKind::Parallel => 32,
        StructureKind::Conversion => 33,
        StructureKind::Assignment => 34,
        StructureKind::Undefined => 35,
        StructureKind::Aborted => 36,
    }
}
...
fn compare_expressions(a: &Expression, b: &Expression) -> std::cmp::Ordering {
    ...
    match (a, b) {
        ...
        (Expression::Text(sa), Expression::Text(sb)) => sa.cmp(sb),
